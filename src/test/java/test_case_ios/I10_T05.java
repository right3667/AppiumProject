...
public class I10_T05 {
	...
	public void I10_T05_case(IOSDriver<IOSElement> driver) {
		app_func.sleep(driver, 3);
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC I10_T05 실행");
		...
		//틀린 OTP 입력 시 LDAP, OTP(LDAP, 미래OTP) 사용자 로그인되지 않음 확인
		...
		//정상 OTP 입력 시 LDAP, OTP(LDAP, 미래OTP) 사용자 로그인됨을 확인
		...
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC I10_T05 종료");
	}
}
