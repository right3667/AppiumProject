...
public class I10_T03 {
	
	func_appium_ios app_func = new func_appium_ios();
	
	Date date_now = new Date(System.currentTimeMillis());
	
	String server_ip = "172.16.150.45";
	String server_port = "443";
	String destination = "30.0.0.5";
	
	public void I10_T03_case(IOSDriver<IOSElement> driver) {
		app_func.sleep(driver, 3);
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC I10_T03 실행");
		...
		driver.findElementByAccessibilityId("tf_login_id").sendKeys("ldap_user");
		...
		app_func.login_server(driver, "ldap_user", "admin123!", 2, 0);
		...
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC I10_T03 종료");
	}
}
