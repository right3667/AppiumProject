...
public class I09_T04 {
	
	func_appium_ios app_func = new func_appium_ios();
	
	Date date_now = new Date(System.currentTimeMillis());
	
	String server_ip = "172.16.150.32";
	String server_port = "443";
	String destination = "30.0.0.5";
	
	public void I09_T04_case(IOSDriver<IOSElement> driver) {
		app_func.sleep(driver, 3);
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC I09_T04 실행");
		...
		app_func.regist_otp_key(driver, "radius_user", "admin123!", "12345678900");
		
		app_func.login_server(driver, "radius_user", "admin123!", 3, 0);
		...
		app_func.regist_otp_key(driver, "radius_user", "admin123!", "1234567890");
		...
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC I09_T04 종료");
	}
}
