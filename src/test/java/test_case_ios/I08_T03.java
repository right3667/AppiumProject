...
public class I08_T03 {
	
	func_appium_ios app_func = new func_appium_ios();
	
	Date date_now = new Date(System.currentTimeMillis());
	
	String server_ip = "172.16.150.43";
	String server_port = "443";
	String destination = "30.0.0.5";
	
	public void I08_T03_case(IOSDriver<IOSElement> driver) {
		app_func.sleep(driver, 3);
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC I08_T03 실행");
		
		app_func.start_app(driver, "com.soosanint.ewalker.vpn.v10", "top icon setting");
		...
		driver.findElementByAccessibilityId("tf_login_id").sendKeys("ad_user");
		...
		app_func.login_server(driver, "ad_user", "admin123!", 2, 0);
		...
		app_func.activate_app(driver, "com.soosanint.ewalker.vpn.v10", "top icon setting");
		
		app_func.logout_server(driver);
		
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC I08_T03 종료");
	}
}
