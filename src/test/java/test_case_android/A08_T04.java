...
public class A08_T04 {
	...
	public void A08_T04_case(AndroidDriver<AndroidElement> driver) {
		...
		test_func.connect_server(driver, "172.16.150.28", "443");
		
		//틀린 OTP 입력 시 AD, OTP(내부, 모바일) 사용자 로그인되지 않음 확인
		test_func.regist_otp_key(driver, "ad_user", "admin123!", "12345678900");
		
		test_func.login_server(driver, "ad_user", "admin123!", 3, 0);
		...
		test_func.regist_otp_key(driver, "ad_user", "admin123!", "1234567890");
