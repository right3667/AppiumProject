...
public class A01_T01 {
	...
	//test_func.activate_app(driver, "kr.co.soosan.vpn.client.v10", "kr.co.soosan.vpn.client.v10:id/action_info");
	MobileElement app_info_btn = (MobileElement) driver.findElementByAccessibilityId("버전정보");
	app_info_btn.click();
	
	test_func.delay(driver, "id", "kr.co.soosan.vpn.client.v10:id/tvEwalkerName", 30);
