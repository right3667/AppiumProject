...
public class A05_T07 {
	...
	public void A05_T07_case(AndroidDriver<AndroidElement> driver) {
		
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC A05_T07 실행");
	    ...
	    String encryption_algorithm = "SEED";
		...
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC A05_T07 종료");
	}
}
