...
public class A06_T02 {
	...
	public void A06_T02_case(AndroidDriver<AndroidElement> driver) {
		...
		test_func.connect_server(driver, "172.16.150.22", "443");
		
		//틀린 OTP 입력 시 로컬, OTP(내부, 모바일) 사용자 로그인되지 않음 확인
		test_func.regist_otp_key(driver, "user_mobile_otp", "admin123!", "12345678900");
		
		test_func.login_server(driver, "user_mobile_otp", "admin123!", 3, 0);
		...
		test_func.regist_otp_key(driver, "user_mobile_otp", "admin123!", "1234567890");
