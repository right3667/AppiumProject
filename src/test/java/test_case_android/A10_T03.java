...
public class A10_T03 {
	
	func_appium_android test_func = new func_appium_android();
	
	Date date_now = new Date(System.currentTimeMillis());
	
	public void A10_T03_case(AndroidDriver<AndroidElement> driver) {
		test_func.sleep(driver, 3);
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC A10_T03 실행");
		...
		test_func.connect_server(driver, "172.16.150.45", "443");
		...
		test_func.login_server(driver, "ldap_user", "admin123!", 2, 0);
		...
		System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(System.currentTimeMillis()) + " " + "TC A10_T03 종료");
	}
}
